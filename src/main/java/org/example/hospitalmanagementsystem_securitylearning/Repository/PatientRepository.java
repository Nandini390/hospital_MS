...
import org.example.hospitalmanagementsystem_securitylearning.Dto.BloodGroupCountResponseEntity;
...
public interface PatientRepository extends JpaRepository<Patient,Long> {
    ...
    @Query("select new org.example.hospitalmanagementsystem_securitylearning.Dto.BloodGroupCountResponseEntity(p.bloodGroup," +
